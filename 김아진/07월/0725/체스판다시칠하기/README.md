...
# 문제 접근
<img src ="https://velog.velcdn.com/images/ppocchi/post/26d03b4e-40d7-4e16-92f3-c7bea81fca7d/image.png" width="90%">
1. 체스 판을 미리 만들어 준다
2. board를 8*8로 잘라 체스판과 비교
 - 체스 판은 row + col이 짝수 or 홀수 일 때의 경우가 같다
